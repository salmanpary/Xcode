  ...
  return (
    <div className="flex flex-col justify-center items-center">
      ...
      <div className="flex px-2 ">
        <div className="border rounded-tl-md  px-2 py-2 w-[13rem] bg-gray-300 font-semibold">Name</div>
        <div className="border rounded-tr-md px-2 py-2 w-[13rem] bg-gray-300 font-semibold">Type</div>
      </div>
      ...
      <div className="flex  items-center">
        ...
        <div className="bg-[#e8f6f0] border border-[#49cc90] px-4 py-2 rounded-r-md flex justify-around items-center w-72">
          <div>/alf/aads/</div>
         <button className="w-16 bg-[#041541] text-white py-[0.3px] rounded-md">
            Docs
         </button>
        </div>
      </div>
