            ...
            <div className="w-[80vw] flex justify-center mt-12">
                <div class="flex flex-wrap  mb-6">
                    <div class=" px-3 flex items-center">
                        ...
                        <input class="appearance-none w-[15rem] ml-4 block w-full bg-gray-200 text-gray-700 border  rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text" placeholder="Jane" />
